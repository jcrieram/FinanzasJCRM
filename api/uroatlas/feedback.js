// /api/uroatlas/feedback — guarda la valoración del Dr. sobre una opinión de UroAtlas.
// POST { case_id, rating (1|-1), comment? }
// Si el comentario tiene suficiente contenido, genera un embedding con Voyage
// para poder recuperarlo en consultas similares futuras.
...
export default async function handler(req, res) {
    ...
    if (!auth.user) return res.status(401).json({ error: 'Requiere autenticación' });

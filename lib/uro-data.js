...
export const CLINIC_LOGOS = {
    'Interclínica Viña del Mar': 'logo_interclinica.png',
...
// Cada clínica puede tener una o varias coordinadoras. Cuando hay más de una,
// la solicitud de cirugía deja elegir cuál incluir.
export const COORDINADORES = {
    'Clínica Miraflores':  [{ nombre: 'Viviana Moreno',  telefono: '+56 9 7779 3590' }],
    'Clínica Los Carrera': [
        { nombre: 'Paula Nuñez', telefono: '+56 9 8501 2657' },
        { nombre: 'Caterina',    telefono: '+56 9 7626 4739' }
    ]
};
...
export const EXAM_PACKAGES = {
    ...
    'Estudio HPB': [
        ...
        { name: 'Glicemia',                               type: 'lab' },
        { name: 'Creatinina',                             type: 'lab' },
        { name: 'Ecografía pelviana con medición de volúmenes', type: 'imagen' },
...
export const STUDY_TEMPLATES = {
    cistoscopia: {
        label: 'Cistoscopía (Interclínica Viña del Mar)',
        title: 'SOLICITUD',
        codigo: '19 01 003',
        ...
        build({ paciente, fields }) {
            ...
            return [
                ...
                `ESTUDIO DE ${motivo}`,
                '',
                'PARA AGENDAR HORA CONTACTAR A YOSELIN AL',
                '32-2323896',
                '(INTERCLÍNICA VIÑA DEL MAR)'
            ].join('\n');
        }
    },
    urodinamia: {
    ...
    derivacion_gonzalez: {
        label: 'Derivación Dr. Manuel González',
        title: 'DERIVACIÓN',
        fields: [
            {
                key: 'caso',
                label: 'Relato del caso',
                type: 'textarea',
                // El cuadro arranca con este encabezado; el médico escribe el
                // relato del caso debajo.
                default: 'Derivación. Dr. Manuel González. Comunicarse al +56 9 9342 1200, María Barrios (asistente).\n\n'
            }
        ],
        build({ fields }) {
            return (fields.caso || '').trim();
        }
    },
    sige: {

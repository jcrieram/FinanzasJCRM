...
export const MEDICATIONS = {
    ...
    'Disfunción eréctil': [
        ...
        { nombre: 'Bectam 20 mg',                 posologia: 'tomar 1 comprimido 30 min antes de la actividad sexual', duracion_n: '', duracion_u: '' }
    ],
    'Antibióticos / ITU': [
    ...
    'Analgésicos / antiinflamatorios': [
        { nombre: 'Prolertus 140 mg',             posologia: 'tomar 1 comprimido al día con alimentos', duracion_n: 5, duracion_u: 'dias' },
        { nombre: 'Promerpal 140 mg',             posologia: 'tomar 1 comprimido al día con alimentos', duracion_n: 5, duracion_u: 'dias' },
    ...
    'Hormonales': [
        { nombre: 'Sustenam 250 mg ampollas',     posologia: 'aplicar 1 ampolla intramuscular cada 2-3 semanas', duracion_n: '', duracion_u: 'permanente' },
        { nombre: 'Nebido 1000 mg ampollas',      posologia: 'aplicar 1 ampolla intramuscular cada 10-14 semanas', duracion_n: '', duracion_u: 'permanente' }
    ],
    'Otros': [
